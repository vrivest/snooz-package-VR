...
See the file LICENCE for full license details.
    ...
    Settings viewer of the EcgFilterOnEeg plugin
"""

from qtpy import QtWidgets

from ModulesPackageVR.EcgFilterOnEeg.Ui_EcgFilterOnEegSettingsView import Ui_EcgFilterOnEegSettingsView
from commons.BaseSettingsView import BaseSettingsView

class EcgFilterOnEegSettingsView(BaseSettingsView, Ui_EcgFilterOnEegSettingsView, QtWidgets.QWidget):
    """
        EcgFilterOnEegView set the EcgFilterOnEeg settings
    """
    ...
    def on_apply_settings(self):
        ...
        """
        # Send the settings to the publisher for inputs to EcgFilterOnEeg
